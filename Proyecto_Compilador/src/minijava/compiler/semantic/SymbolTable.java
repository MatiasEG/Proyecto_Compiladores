...
public class SymbolTable {
    ...
    private void createConcreteClasses() throws SemanticException {
        createObjectClass();
        createStringClass();
        createSystemClass();
    }
